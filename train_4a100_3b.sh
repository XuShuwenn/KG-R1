...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-cwq-4a100-qwen2.5-3b-sft-synth-filtered-7k-deepseekv3-2}"
...
# -----------------------------
# Launch PPO training (4 A100, 3B model)
# -----------------------------
python -m verl.trainer.main_ppo \
    ...
    +reward_model.reward_kwargs.global_exact_match=0.40 \
